...
// 1c
	i = update_menu_structs(i, 1, _exec_choice,	choice1, choice2, choice3, choice4, choice5, choice6, 0);
// 1d
	i = update_menu_structs(i, 1, _do_chkbox, choice1, choice2, choice3, choice4, choice5, choice6, 0);
// 2a
	i = update_menu_structs(i, 1, _non_func, choice1, choice2, choice3, choice4, choice5, choice6, 0);
// 2b
	i = update_menu_structs(i, 1, _exec_choice,	choice1, choice2, choice3, choice4, choice5, choice6, 0);
// 2c
	i = update_menu_structs(i, 1, _start_numentry, choice1, choice2, choice3, choice4, choice5, choice6, 0);
