...
{
	int fp;
	char filename[20] = "waypoints2.conf\0";
	char *fptr = filename;
	WAYPOINTS ps;
	UCHAR id = 0xAB;
	...
	strcpy(ps.name,"point A\0");
	ps.latitude = 43.759182;
	ps.longitude = -105.488990;
	write(fp,&ps,sizeof(WAYPOINTS));

	strcpy(ps.name,"point B\0");
	ps.latitude = 43.757712;
	ps.longitude =  -105.488689;
	write(fp,&ps,sizeof(WAYPOINTS));

	strcpy(ps.name,"point C\0");
	ps.latitude = 43.757937;
	ps.longitude =  -105.488587;
	write(fp,&ps,sizeof(WAYPOINTS));

	strcpy(ps.name,"point D\0");
	ps.latitude = 43.758231;
	ps.longitude =  -105.488550;
	write(fp,&ps,sizeof(WAYPOINTS));

	strcpy(ps.name,"point E\0");
	ps.latitude = 43.758613;
	ps.longitude =   -105.488523;
	write(fp,&ps,sizeof(WAYPOINTS));

	strcpy(ps.name,"point F\0");
	ps.latitude = 43.759020;
	ps.longitude =  -105.488668;
	write(fp,&ps,sizeof(WAYPOINTS));

	strcpy(ps.name,"point G\0");
	ps.latitude = 43.759427;
	ps.longitude =  -105.488968;
	write(fp,&ps,sizeof(WAYPOINTS));

	strcpy(ps.name,"point H\0");
	ps.latitude = 43.760159;
	ps.longitude = -105.489574;
	write(fp,&ps,sizeof(WAYPOINTS));
