...
//#define			IOCARDBASEADD72			0xEC000000	// 8-bit memory
#define			IOCARDBASEADD72			0xEE000000	// 8-bit io				(this one works)
//#define			IOCARDBASEADD72			0xED000000	// 16-bit memory
//#define			IOCARDBASEADD72			0xEF000000	// 16-bit io
...
int main(int argc, char **argv)
{
	...
	card_ports = (VUCHAR *)mmap(0, card_pagesize, PROT_READ|PROT_WRITE, MAP_SHARED, fd, IOCARDBASEADD72);
