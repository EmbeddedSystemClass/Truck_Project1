/* show_params.c - actual values of rpm_update_rate->low_rev_limit & lights_on_delay is 
...
*/
	...
	printf("cooling_fan_off:\t\t%s\r\n",get_temp_str(ps.cooling_fan_off));
	printf("blower_enabled:\t\t\t%s\r\n",get_temp_str(ps.blower_enabled));
